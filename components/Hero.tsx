      ...
      <div className="py-20 sm:py-28">
        <div className="max-w-4xl">
          ...
          <div className="intro-capabilities mt-12">
            <p className="font-mono text-xs uppercase tracking-[0.18em] text-cp-blue">
              Skills
            </p>
            <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-2 font-mono text-sm text-cp-text">
              <span>Java</span><span className="text-cp-overlay">/</span>
              <span>Spring Boot</span><span className="text-cp-overlay">/</span>
              <span>Kafka</span><span className="text-cp-overlay">/</span>
              <span>AWS</span><span className="text-cp-overlay">/</span>
              <span>MongoDB</span><span className="text-cp-overlay">/</span>
              <span>Microservices</span><span className="text-cp-overlay">/</span>
              <span>Kubernetes</span><span className="text-cp-overlay">/</span>
              <span>Linux</span>
            </div>
          </div>
        </div>
